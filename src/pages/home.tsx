                            ...
                            <div className="relative aspect-[4/6] overflow-hidden bg-stone-100 shadow-sm transition-all duration-500 group-hover:shadow-2xl">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                                    <button
                                        ...
                                        className="w-full py-3 bg-white text-black text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-[#c5a059] hover:text-white transition-colors"
                                    >
                                        View Details
                                    </button>
                                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-white/5 border border-white/10 p-10 backdrop-blur-sm space-y-6 text-left">
                            <div>
                                ...
                                <p className="text-xl font-light">+91 82994 01248</p>
                            </div>
                            <div className="pt-6 border-t border-white/10">
                                <p className="text-[#c5a059] text-[10px] font-bold uppercase tracking-widest mb-2">Email Address</p>
                                <p className="text-xl font-light underline decoration-[#c5a059]/30 break-all leading-tight">gangahandmadeexport@gmail.com</p>
                            </div>
                            <div className="pt-6 border-t border-white/10">
